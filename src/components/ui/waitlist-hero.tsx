...
export const WaitlistHero = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      // Open Cal.com link
      setTimeout(() => {
        window.open("https://cal.com/flowstra/30min", "_blank");
      }, 1000);
    }, 1500);
  };
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center">
      ...
      {/* Main Container */}
      <div
        className="relative w-full h-screen overflow-hidden shadow-2xl rounded-3xl"
        style={{
          fontFamily:
      ...
      >
        ...
        <div className="relative z-20 w-full h-full flex flex-col items-center justify-end pb-24 gap-6 px-4">
          ...
          <div
            className="w-full max-w-md mt-4 h-[60px] relative mt-8"
