...
export function ClippedVideoTab() {
  ...
  return (
    <div className="py-20 overflow-hidden w-full max-w-7xl mx-auto rounded-3xl mt-12 bg-transparent text-left">
      {/* TOP */}
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="w-[320px] max-md:w-[90%] rounded-[26px] border border-white/30 bg-white/80 backdrop-blur-xl shadow-2xl p-5"
              >
                {/* HEADER */}
