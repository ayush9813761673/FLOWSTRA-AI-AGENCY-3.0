...
export function GlowingShadow({
  ...
  return (
    <>
      <style
        ...
        .glow-content:before {
          ...
          background: hsl(0deg 0% 16%) radial-gradient(
            ...
            hsl(220 100% 80%) calc(20% * var(--bg-size)),
            hsl(240 100% 60%) calc(40% * var(--bg-size)),
            transparent 100%
          );
      ...
      <div className={cn("glow-container w-full h-full", containerClassName)}>
        <span className="glow"></span>
        <div
          className={cn(
            "glow-content w-full h-full text-left bg-[var(--surface)] relative z-10 overflow-hidden",
            className,
          )}
        >
          {children}
