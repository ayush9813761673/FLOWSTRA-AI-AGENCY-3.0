          ...
          {testimonials.map((item, idx) => {
            return (
              <motion.div
                key={idx}
                variants={fadeUp}
                className="group relative flex flex-col justify-between h-[480px] rounded-2xl border border-zinc-800/80 bg-zinc-950/40 p-6 md:p-8 backdrop-blur-md transition-all duration-300 hover:border-zinc-700/80 hover:bg-zinc-900/40"
              >
